...
public class HueShifter : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
          rend.material.SetColor("_Color", new Color(1, 0.67450980392f, 0));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 3)
        {
          rend.material.SetColor("_Color", new Color(1, 1, 0));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 4)
        {
          rend.material.SetColor("_Color", new Color(0, 1, 0));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 5)
        {
          rend.material.SetColor("_Color", new Color(0, 0, 1));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 6)
        {
          rend.material.SetColor("_Color", new Color(0.81568627451f, 0, 1));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 7)
        {
          rend.material.SetColor("_Color", new Color(0, 1, 1));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 8)
        {
          rend.material.SetColor("_Color", new Color(0.83137254902f, 1, 0));
        }
        ...
        {
          rend.material.SetColor("_Color", new Color(1, 0, 0.69803921568f));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 11)
        {
          rend.material.SetColor("_Color", new Color(0.56862745098f, 0, 1));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 12)
        {
          rend.material.SetColor("_Color", new Color(0, 1, 0.76078431372f));
        }
        if (PlayerPrefs.GetInt("SpriteColor", 0) == 13)
        {
          rend.material.SetColor("_Color", new Color(1, 0.54901960784f, 0.54901960784f));
        }
    ...
    void Update()
    {
        if (changeColor)
        {
            rend.material.SetColor("_Color", HSBColor.ToColor(new HSBColor( Mathf.PingPong(Time.time * 0.025f, 1), 1, 1)));
        }
    }
}
